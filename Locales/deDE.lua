--[[
- Die Präfixe der Sprachfunktionen werden die mit X, Y und Z benannt.
- Sie und KEYS der Übersetzungen werden in Großbuchstaben angegeben.
- Wenn man mehr als X, Y und Z braucht, fängt man mit X1, Y1 und Z1 an.
]]

local L = LibStub('AceLocale-3.0'):NewLocale('MathQuiz', 'deDE', true);
