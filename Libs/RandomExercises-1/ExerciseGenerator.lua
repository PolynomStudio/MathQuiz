...
ns.ExerciseGenerator = {}
ns.ExerciseGenerator.__index = ns.ExerciseGenerator
...
function ns.ExerciseGenerator:create(max_depth, pruning_factor, usable_on_all_levels, usable_on_low_level)
  local gen = {}
  setmetatable(gen, ns.ExerciseGenerator)
  gen.max_depth = max_depth
  gen.pruning_factor = pruning_factor
  gen.usable_on_all_levels = usable_on_all_levels or ns.AvailableFunctions.usable_on_all_levels
  gen.usable_on_low_level = usable_on_low_level or ns.AvailableFunctions.usable_on_low_level
  return gen
end
...
function ns.ExerciseGenerator:random_exercise()
  local tree = ns.Tree:create(self.max_depth, self.usable_on_all_levels, self.usable_on_low_level, self.pruning_factor)
